...
def flow_rtpo_sd3_local():
    ...
    # Dataset configuration - LOCAL RTP dataset
    ...
    # Target VLM configuration - LOCAL LLaVA
    ...
    # Logging and saving - LOCAL paths
...
def get_config(config_name="flow_rtpo_sd3_local"):
    """Get configuration by name."""
    if config_name == "flow_rtpo_sd3_local":
...
if __name__ == "__main__":
    # Test configuration
    config = flow_rtpo_sd3_local()
    print("Flow-RTPO Local Configuration:")
    print(config)
